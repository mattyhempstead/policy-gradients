"""
This script trains an agent for cartpole using MC policy gradients and normalising rewards
Hard to tell if normalising improves much, but it probably does
"""
